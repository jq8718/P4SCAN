...
esp_err_t esp_video_csi_check_format(esp_cam_sensor_output_format_t sensor_fmt, uint32_t v4l2_fmt, esp_video_csi_isp_in_out_format_t *in_out_format)
{
    ...
    if (isp_bypass_required) {
        ...
        in_out_format->isp_output_fmt = in_out_format->isp_input_fmt == ISP_COLOR_RAW10 ?
                                         ISP_COLOR_RAW8 : in_out_format->isp_input_fmt;
        in_out_format->isp_bpp = isp_color_to_bpp(in_out_format->isp_input_fmt);
        ...
        ESP_LOGI(TAG, "CSI format: sensor=%" PRIx32 " requested=%" PRIx32
                 " ISP in=%d out=%d bypass=%d CSI in=%d out=%d",
                 sensor_v4l2_fmt, requested_fmt,
                 in_out_format->isp_input_fmt, in_out_format->isp_output_fmt,
                 in_out_format->isp_bypass_required,
                 in_out_format->csi_input_fmt, in_out_format->csi_output_fmt);
